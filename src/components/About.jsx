...
const About = () => {
  return (
    <>
      ...
      >
       I'm a skilled software developer with experience in .NET, Azure, AWS, databases, Node.js, React, and ERP software development. I'm well-versed in Docker, CI/CD processes, GitHub, and TypeScript. I quickly adapt to new technologies and collaborate closely with clients to deliver efficient, scalable, and user-friendly solutions that solve real-world problems. Let's work together to bring your ideas to life!
      </motion.p>
